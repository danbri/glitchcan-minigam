...
# This script generates JavaScript that will create optimized versions of the textures 
# at runtime rather than requiring image processing tools to be installed.
...
with open("resized/texture_optimizer.js", "w") as f:
    f.write(js_code)

print("Created texture_optimizer.js in the resized directory")